...
export default defineConfig({
  ...
  // never inline them. Keeping @ministryofmany/* external preserves each primitive's
  ...
  external: ["@ministryofmany/membership", "@ministryofmany/nullifier", "@ministryofmany/policy", "zod"],
  target: "es2022",
});
